...
alias devpc="rdesktop -k en-us -a 16 -u Administrator -p 'yKUh&*fTGiL$ydLNvmz@!(OQjA*nwYJG' 54.152.25.102 -c Work -g 1280x720 "

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion

source "/home/agustin/.oh-my-zsh/custom/themes/spaceship.zsh-theme"
# ORDER
